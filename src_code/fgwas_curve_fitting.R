...
#obj.phe_AA <- fg.load.phenotype( file.phe.long_AA, file.phe.cov_AA, file.phe.time_AA, file.plot.pdf="/ddn/home2/r2725/projects/jeannette/data/curve.fitting_AA.pdf")
